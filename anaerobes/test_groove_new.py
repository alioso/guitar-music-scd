...
boxes.append(newobj("grv",     "groove~ tb 0",       2, 2, ["signal","signal"], 40, 165, 110))
boxes.append(newobj("rate",    "sig~ 1.",             1, 1, ["signal"],        170, 165,  55))
...
boxes.append(msg(   "rec_on",  "start",                                         370, 265, 45))
boxes.append(msg(   "grv_loop","loop 1",                                        300, 305, 55))
boxes.append(msg(   "grv_on",  "start",                                         370, 305, 45))
...
lines.append(line("rate",    0, "grv",      1))
